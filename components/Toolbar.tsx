...
export const Toolbar: React.FC<ToolbarProps> = ({ activeFormats, pageTitle }) => {
  ...
  return (
    <div className="bg-[#F0F4F8] rounded-full mx-2 md:mx-4 mb-2 px-4 py-1.5 flex items-center gap-1 shadow-sm overflow-x-auto sticky top-2 z-10 border border-transparent max-w-[95vw] no-scrollbar print:hidden">
      ...
      {/* Zoom - Disabled UI */}
      <div className="flex items-center gap-1 px-2 py-1 rounded text-xs font-medium text-gray-400 cursor-default opacity-60 shrink-0">
      ...
      {/* Styles - Disabled UI */}
      <div className="flex items-center gap-1 px-2 py-1 rounded text-sm text-gray-400 w-24 truncate shrink-0 justify-between cursor-default opacity-60">
